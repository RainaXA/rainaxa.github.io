    ...
    <main className="flex flex-col">
        <div className="bg-center bg-no-repeat bg-[url('/jumbotron.webp')] bg-gray-500 bg-blend-multiply">
            <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56 space-y-3">
                <h1 className="font-light md:text-5xl text-4xl">Welcome to the Federal Democracy of Solstice</h1>
                <h2 className="font-light md:text-3xl text-xl">The official website of the Federal Democracy of Solstice</h2>
            </div>
        </div>
            <ul>
                <li>
                    <div className="bg-center bg-no-repeat bg-[url('/provinces/firefly.webp')] bg-gray-600 bg-blend-multiply">
                        <div className="sm:px-40 px-10 py-14 space-y-2">
                            <h1 className="font-light sm:text-5xl text-3xl">Firefly</h1>
                ...
                <li>
                    <div className="bg-center bg-no-repeat bg-[url('/provinces/prehevil.webp')] bg-gray-600 bg-blend-multiply">
                        <div className="sm:px-40 px-10 py-14 space-y-2">
                            <h1 className="font-light sm:text-5xl text-3xl">Prehevil</h1>
